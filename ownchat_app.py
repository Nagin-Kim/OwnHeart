...
# Author: WENGJINTA <wengjinta@iie.ac.cn>
# Date: 2024.02.06
...
streamlit run ownchat_app.py --server.port 9026
```
## 测试访问
http://<your_ip>:9026
...
# 下载模型并且指定路径
model_name_or_path = 'Nagin/OwnHeart'
...
def answer(user_history, bot_history, sample=True, top_p=0.75, temperature=0.95):
    ...
    if len(bot_history)>0:
        ...
        return "你好！我是你的个人专属数字辅导员金塔吉人，欢迎找我倾诉、谈心，期待帮助到你！"
...
if st.session_state['generated']:
    for i in range(len(st.session_state['generated'])):
        if i == 0:
            ...
            message("你好！我是你的个人专属数字辅导员金塔吉人，欢迎找我倾诉、谈心❤️，期待帮助到你！🤝🤝🤝"+"\n\n------------------\n以下回答由一颗心大模型自动生成，仅供参考！", key=str(i), avatar_style="avataaars", seed=5)
        else:
            message(st.session_state['past'][i], is_user=True, key=str(i) + '_user', avatar_style="avataaars", seed=26)
